...
scanf(" %i", &Numero_de_pontos_turisticos);
  ...
  // Inicio dos calculos adicionais para carta 1

Densidade_Populacional = (Populacao / area);
PIB_per_capita = (PIB / Populacao);

  // Fim dos calculos adicionais para carta 1
...
printf("A Densidade populacional da sua cidade e: %f\n", Densidade_Populacional);
printf("O PIB per capita da sua cidade e: %f\n", PIB_per_capita);  
...
scanf(" %i", &Numero_de_pontos_turisticos);
  ...
  // Inicio dos calculos adicionais da segunda carta
Densidade_Populacional = (Populacao / area);
PIB_per_capita = (PIB / Populacao);
 
  // Fim dos calculos adicionais da segunda carta
